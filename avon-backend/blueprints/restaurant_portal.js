...
<div class="blueprint-container min-h-screen bg-white text-gray-900 font-sans">
    <header class="sticky top-0 z-50 bg-white/90 border-gray-100 shadow-sm backdrop-blur-xl border-b px-8 py-5 flex justify-between items-center transition-all">
        <div class="flex items-center gap-10">
            <h2 class="text-2xl font-black italic tracking-tighter uppercase">
                Dine-In <span class="text-blue-600">Hub</span>
            </h2>
    ...
    <section id="home" class="relative py-24 md:py-40 px-8 max-w-7xl mx-auto overflow-hidden">
        <div class="grid lg:grid-cols-2 gap-20 items-center">
            <div class="space-y-8">
                <span class="inline-flex items-center gap-2 px-3 py-1 bg-white border-gray-100 shadow-sm rounded-[24px] border rounded text-[10px] font-bold uppercase tracking-widest text-blue-600">Food Division // 2026</span>
                <h1 class="text-7xl md:text-8xl font-black italic tracking-tighter leading-[0.85] uppercase">Dine-In Hub</h1>
                <p class="text-gray-500 text-lg leading-relaxed max-w-lg">Menu management and table booking. Engineered for the 2026 industrial era.</p>
            ...
            <div class="relative group">
                <img src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&q=80&w=1000" class="rounded-[48px] shadow-2xl transition-transform duration-700 group-hover:scale-[1.02]" alt="Dine-In Hub" />
            </div>
        </div>
    </section>
    ...
    <section id="pricing" class="py-32 px-8 max-w-7xl mx-auto">
        <div class="text-center mb-24 space-y-4">
            ...
            <p class="text-gray-500 max-w-xl mx-auto">Scale your food empire through these verified structural tiers.</p>
        </div>
